        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6>Pesanan anda sudah sukses dicheck out selanjutnya untuk pembayaran silahkan transfer di rekening <strong>Bank BRI </strong></h6>
                    <h6><strong>Nomer Rekening : 6313-03-34-234-22</strong></h6>
                    <h6><strong>Atas Nama : M Rizky Sulistyawan</strong></h6>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td>
                                    <img src="{{ url('assets/jersey') }}/{{ $pesanan_detail->barang->gambar }}" width="100" alt="...">
                                </td>
